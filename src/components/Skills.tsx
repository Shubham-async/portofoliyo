...
import { SiTailwindcss, SiTypescript, SiExpress, SiRedux } from 'react-icons/si';

const skills = [
    { icon: <FaReact />, label: 'React', level: 70 },
    { icon: <DiJavascript />, label: 'JavaScript', level: 70 },
    { icon: <SiTypescript />, label: 'TypeScript', level: 50 },
    { icon: <SiTailwindcss />, label: 'Tailwind CSS', level: 75 },
    { icon: <FaNodeJs />, label: 'Node.js', level: 65 },
    { icon: <SiExpress />, label: 'Express.js', level:65 },
    { icon: <FaReact />, label: 'MongoDB', level:60 },
    { icon: <FaGitAlt />, label: 'Git', level: 60 },
    { icon: <PiOpenAiLogo />, label: 'AI Tools', level: 40 }
